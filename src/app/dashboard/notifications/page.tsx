...
export default function NotificationsPage() {
    ...
    const getEmptyDescription = (): string => {
        if (allNotifications.length === 0) {
            return 'Powiadomienia pojawią się automatycznie gdy klienci zaczną interagować z Twoimi ofertami i umowami';
        }
        if (activeTab === 'unread') return 'Nie masz nieprzeczytanych powiadomień';
        if (activeTab === 'read') return 'Brak przeczytanych powiadomień';
        if (typeFilter) return 'Brak powiadomień tego typu';
        return 'Brak powiadomień spełniających kryteria';
    };
    ...
    return (
        <div className="p-4 sm:p-6 lg:p-8 max-w-5xl mx-auto">
            ...
            {isLoading ? (
                ...
                <div className="card-themed border rounded-2xl">
                    <EmptyState
                        icon={
                        ...
                        title={allNotifications.length === 0 ? 'Brak powiadomień' : 'Brak wyników'}
