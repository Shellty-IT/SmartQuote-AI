...
import { useOfferPublish } from '@/hooks/useOffers';
                ...
                <div className="p-6">
                    ...
                    {!wasPublished ? (
                        <div>
                            <div className="bg-slate-50 rounded-xl p-4 mb-6">
                                ...
                                <ul className="mt-3 space-y-2">
                                    <li className="flex items-center gap-2 text-sm text-slate-600">
                                        ...
                                        Przeglądać pozycje oferty
                                    </li>
                                    <li className="flex items-center gap-2 text-sm text-slate-600">
                                        <svg className="w-4 h-4 text-cyan-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                                        </svg>
                                        Wybierać opcjonalne pozycje i zmieniać ilości
                                    </li>
                                    <li className="flex items-center gap-2 text-sm text-slate-600">
                                        <svg className="w-4 h-4 text-cyan-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                                        </svg>
                                        Zadawać pytania przez komentarze
                                    </li>
                                    <li className="flex items-center gap-2 text-sm text-slate-600">
                                        <svg className="w-4 h-4 text-cyan-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                            ...
                            {validUntil && (
                                <div className={`flex items-center gap-2 p-3 rounded-xl mb-6 ${isExpired ? 'bg-red-50 border border-red-200' : 'bg-blue-50 border border-blue-200'}`}>
                        ...
                        <div>
                            ...
                            <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 mb-6">
                                <div className="flex items-start gap-2">
                                    ...
                                    <p className="text-sm text-emerald-700">
                                        Link jest aktywny. Wyślij go klientowi mailem, SMS-em lub komunikatorem.
                                        Każde otwarcie i akcja klienta będą widoczne w analityce oferty.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-3">
                                <button
                                    ...
                                    className="px-4 py-3 rounded-xl border border-red-200 text-red-600 font-medium hover:bg-red-50 transition-colors disabled:opacity-50 flex items-center gap-2"
                                >
                                    {isUnpublishing ? (
                                        <>
